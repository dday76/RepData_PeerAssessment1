...
All the files are included. The html file has all the commentary, code, and output you'll need. The Rmd produces the md and that produces the html as intended.

## Requirements (per the list at the top... The Rmd goes by the list of questions)
